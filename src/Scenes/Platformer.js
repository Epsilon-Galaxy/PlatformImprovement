class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        this.tiledWater = this.map.createFromObjects("Objects", {
            name: "waterTile",
            key: "tilemap_sheet",
            frame: 33
        })
        ...
        this.physics.world.enable(this.tiledWater, Phaser.Physics.Arcade.STATIC_BODY);
        ...
        this.waterGroup = this.add.group(this.tiledWater);
        ...
        this.physics.add.overlap(my.sprite.player, this.powerUpGroup, (obj1, obj2) => {
            ...
            obj2.destroy();
            this.POWERUPACIVE = true;
        })

        this.physics.add.overlap(my.sprite.player, this.tiledWater, (obj1, obj2) => {
            this.add.particles(obj2.x, obj2.y, "kenny-particles", {
            ...
            obj1.x = this.spawn[0].x;
            obj1.y = this.spawn[0].y;
        })
    ...
    update() {
        ...
        if(this.POWERUPACIVE == true){
            this.POWERUPCOUNTER ++;
            this.JUMP_VELOCITY = -700;
            if(this.POWERUPCOUNTER >= this.POWERUPTIMER){
                this.POWERUPACIVE = false;
                this.POWERUPCOUNTER = 0;
                this.JUMP_VELOCITY = -600;
            }
